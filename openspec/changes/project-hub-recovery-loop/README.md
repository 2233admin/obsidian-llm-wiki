...
4. [`tasks.md`](tasks.md) — review gate and bounded implementation sequence.
...
No implementation may start from this OpenSpec until Phase 0 is approved. Luna receives only an approved task slice, its exact file scope, and its required verification commands.