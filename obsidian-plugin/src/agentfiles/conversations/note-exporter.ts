...
export function generateNotePath(conversation: ConversationItem, vaultPath: string): string {
	...
	return `${vaultPath}/00-Inbox/AI-Output/agentfiles/Claude Sessions/${date}-${slug}.md`;
}
...
/** The governed AI Output executor owns frontmatter and accepts body Markdown only. */
