---
name: x-to-obsidian
description: Capture high-signal X/Twitter posts into an Obsidian vault through the official Obsidian Web Clipper, then let LLMwiki search, review, and promote the saved notes.
---
...
5. Use LLMwiki MCP search to confirm the clipped note can be found in the vault.
...
- Preserve source URLs and visible metadata so later LLMwiki answers can cite the saved note.
