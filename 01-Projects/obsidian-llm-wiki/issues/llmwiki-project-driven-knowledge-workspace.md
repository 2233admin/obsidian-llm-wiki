...
- **Decision outcome**: Recovery-required S01B–S08 work is part of Foundation exit; S01B–S04A are verified completions, and implementation proceeds blockers-first from reviewed S06A
...
5. **Next — S06A** proves the ephemeral read-only Flow through Ask Mate Project Context in actual Obsidian.
